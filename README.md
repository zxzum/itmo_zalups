...
Доступна версия с графическим интерфейсом на Qt6! 
...
- 📋 Автоматический парсинг и отображение информации о композиции
- 🇷🇺 Полностью русский интерфейс
- 🖱️ Поддержка Drag & Drop
...
### Скриншоты:
![GUI с подсветкой синтаксиса](screenshots/gui_with_syntax_highlighting.png)
