/****************************************************************************
** Meta object code from reading C++ file 'waveformwidget.hpp'
**
...
#include <memory>
#include "../../../../gui/waveformwidget.hpp"
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'waveformwidget.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WaveformWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_WaveformWidget_t qt_meta_stringdata_WaveformWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_WaveformWidget[] = {
...
Q_CONSTINIT const QMetaObject WaveformWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_WaveformWidget.offsetsAndSizes,
    qt_meta_data_WaveformWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_WaveformWidget_t,
        // Q_OBJECT / Q_GADGET
